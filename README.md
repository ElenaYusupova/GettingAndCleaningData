...
The data from the project were extracted from the following database: 
...
The information was used to clean the data in line with the instructions
======================================================
